...
UPDATE users SET profileImageUrl = '/uploads/sample1.jpg' WHERE id IN (100, 102, 108, 120) AND (profileImageUrl IS NULL OR profileImageUrl = '');
UPDATE users SET profileImageUrl = NULL WHERE id IN (101, 110, 121);
